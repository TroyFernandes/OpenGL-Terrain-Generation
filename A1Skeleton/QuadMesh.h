...
//Struct for the hole. X and Z are the respective locations
...
void UpdateMesh(QuadMesh* qm);//update the mesh
void MakeHole(QuadMesh* qm, float xPos, float zPos);//make the hole